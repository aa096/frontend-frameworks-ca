...
function ContactForm() {
  ...
  return (
    <div className="flex mt-4 justify-center">
     <form className="bg-white p-8 flex justify-center" onSubmit={handleSubmit((data) => { onSubmit(data);})}>
        <fieldset>
          ...
          <div className="form-control w-full max-w-md mx-auto mt-3">
            ...
            <textarea
              ...
              {...register("body", { 
                ...
                minLength: { value: 3, body: "Message must be at least 3 characters" } 
              })}
              rows="5"
            />
          ...
          <div className="form-control w-full max-w-md mx-auto">
            <button type="submit" className="bg-primary hover:bg-primary mt-2 text-white font-bold py-2 px-4 rounded-md w-full">
              Send Message
            </button>
          </div>
        </fieldset>

        ...
        <footer className="bg-primary text-white py-6">
          <div className="container mx-auto text-center">
            ...
            <nav className="flex justify-center space-x-6 mt-4">
              <p className="hover:text-secondary transition-colors duration-200 cursor-pointer">Privacy Policy</p>
              <p className="hover:text-secondary transition-colors duration-200 cursor-pointer">Terms of Service</p>
